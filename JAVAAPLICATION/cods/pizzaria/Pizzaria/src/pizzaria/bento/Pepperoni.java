...
public class Pepperoni extends Pizza {
	...
	String ingredientes[] = { "Molho tomate", "Queijo Provolone", "Peperoni", "Tomate", "Pimentão em fatias", "Cebola em fatias",
	...
	public void assar() {		
		System.out.println();
		System.out.println(String.format("%s %s %s", "Sua pizza de ", super.getNome(), " ficará pronta em 9 min"));
		System.out.println();
		super.cortar();
	}	
