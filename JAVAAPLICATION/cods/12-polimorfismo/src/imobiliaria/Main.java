...
class Main {
  public static void main(String[] args) {
    ...
    Locacao loc1 = new Residencial("Rua Alfredo Huch, 475", 2, 1, 900.0, 100.0);
    ...
    Locacao loc3 = new Comercial("Aquidaban, 8350", 0, 0, 1000.0, 500.0);
    // constantes/imutáveis
    ...
    Cobranca cobranca = 
    		new Cobranca(loc1, loc2, loc3);
    
    System.out.println(cobranca.valorTotal());
    cobranca.pagar();
