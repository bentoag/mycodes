	...
	public static void main(String[] args) {
		...
		do {
			try {
				...
				throw new ImproperFractionException("minha execeção");
			}
		} while (repetir);
	}//fim do metodo main
	
	public void biggestNumerator() throws ImproperFractionException{
		throw new ImproperFractionException("Está é uma fração imprópria. O numerador é maior que o denominador");
	}
