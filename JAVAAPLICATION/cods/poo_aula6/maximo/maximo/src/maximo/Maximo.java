	...
	public static void main(String[] args) {
		if (args.length == 1) {
			...
			case 1:
				...
				break;
			case 2:
				System.out.printf("Máximo é: %d%n", max(-1234, 12, 23, 9908293, -9908393));
				break;
			case 3:
			...
			System.out.println("Número do exemplo não informado! Abortando.");
		} // fim do if
	} // fim do método main
