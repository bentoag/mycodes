...
public class Loja {
	...
	public static void main(String[] args) {
		...
		System.out.printf("%s  %.2f  %n","Seu  Salário neste mês foi de: R$  ", salario);
		System.out.printf("%s  %.2f", "Total vendido no mês R$ ", vendedor1.getTotalVendidoMes());
		
		Vendedor vendedor2 = new Vendedor("José");	
		vendedor2.setTotalVendidoMes(5000);
		System.out.println();
		System.out.println("Vendedor 2 -->");
		System.out.printf("%s  %.2f", "Total vendido no mês R$ ", vendedor2.getTotalVendidoMes());
