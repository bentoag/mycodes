...
//classe define minha janela padrão
public class MainFrame extends JFrame {
	...
	public MainFrame() {
		super(TITLE);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); //opção para fechamento da janela
	...
	public void showFrame() {
		setLocationRelativeTo(null); // define a localização da janela com relação aos componentes --> null fica no centro
		setVisible(true);
	}
