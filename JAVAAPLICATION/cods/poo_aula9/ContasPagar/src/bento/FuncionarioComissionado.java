...
public class FuncionarioComissionado extends Funcionario {
	...
	public String toString() {
		return String.format("%s: %s%n\t%s: $ %.2f%n\t%s: %d %%%n\t%s: $ %.2f%n", "Funcionário comissionado",
				super.toString(), "Valor vendido", this.valorVendido, "Porc. comissão", this.porcentualComissao,
				"Salário", calcularSalarioMensal());
	}
