...
public class FuncionarioHorista extends Funcionario {
	...
	public String toString() {
		return String.format("%s: %s%n\t%s: %d%n\t%s: $ %.2f%n\t%s: $ %.2f%n", "Funcionário horista", super.toString(),
				"Horas trabalhadas", this.horasTrabalhadas, "Valor por hora", this.valorPorHora, "Salário",
