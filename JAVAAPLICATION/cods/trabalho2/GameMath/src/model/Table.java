...
public class Table extends AbstractTableModel {
	...
	private String[] columns = new String[] {"ID", "Pergunta", "Resposta correta"};
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		if (rowIndex >= 0 && rowIndex < questions.size()) {
			...
			case 1:
				...
				break;
			case 2:
				value = question.getCorrectAnswer().toString();
				break;
			default:
				System.err.printf("ERROR: Indice invalido para a coluna: %d\n", columnIndex);
				break;
			}
		}
		return value;
	...
	public void load(List<Question> questions) {
		for (int i = 0; i < questions.size(); i++) {
			questions.get(i).setAnswers(AnswerDataBase.list(questions.get(i).getId()));
		}
